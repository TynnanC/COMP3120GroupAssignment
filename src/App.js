...
const App = () => {
    ...
    return ( <
        ...
        Auth0Login setTrainer = { setTrainer }
        trainer = { trainer }
        />{" "} <
        /div>{" "} <
        Switch > { " " } { /*The switch defines the routes and URL paths used.*/ } { " " } <
        Route path = "/client" >
        <
        ClientProfile Ouruser = { Ouruser }
        ...
        Route path = "/trainer" >
        <
        TrainerProfile setourUser = { setourUser }
